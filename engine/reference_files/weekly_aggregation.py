...
if __name__ == '__main__':
    ...
    map_add_function = Code(open(join(JAVASCRIPT, AGGREGATION_MAP_ADD_FUNCTION), 'r').read())
    map_subtract_function = Code(open(join(JAVASCRIPT, AGGREGATION_MAP_SUBTRACT_FUNCTION), 'r').read())
    reduce_function = Code(open(join(JAVASCRIPT, AGGREGATION_REDUCE_FUNCTION), 'r').read())
